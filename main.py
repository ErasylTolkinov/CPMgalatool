...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            console.print("[bold][cyan](12):[/cyan] [green]Unlock all Cars ~ 4000[/green]")
            console.print("[bold][cyan](13):[/cyan] [green]Unlock all Cars Siren ~ 3000[/green]")
            console.print("[bold][cyan](14):[/cyan] [green]Unlock w16 Engine ~ 2000[/green]")
